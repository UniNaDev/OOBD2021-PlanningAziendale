...
public interface MeetingDAO {
	...
	public ArrayList<Dipendente> getInvitati(Meeting meeting) throws SQLException;	//metodo che restituisce gli invitati a un meeting
	public boolean addMeeting(Meeting meeting) throws SQLException;	//metodo che aggiunge un meeting al DB
	public boolean removeMeeting(Meeting meeting) throws SQLException;	//metodo che rimuove un meeting dal DB
