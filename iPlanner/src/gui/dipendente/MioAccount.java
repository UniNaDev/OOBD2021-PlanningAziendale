...
public class MioAccount extends JFrame {
			...
			public void windowClosing(WindowEvent evt) {
				if (modificheEffettuate) {
					int risposta = JOptionPane.showConfirmDialog(null,
							"Sei sicuro di uscire? Le modifiche non verranno salvate.", "Salvataggio Modifiche",
	...
	private void aggiornaAccount(ControllerGestioneProfilo controller, Dipendente dipendente) {
		try {
			...
			if (modificheEffettuate)
				JOptionPane.showMessageDialog(null, "Modifica Effettuata con successo.", "Salvataggio Riuscito",
			...
			case VIOLAZIONE_VINCOLI_TABELLA:
				errore = new ErroreDialog(eccezioneSQL, "Salvataggio Fallito", "Verificare che:\n"
			...
			case VIOLAZIONE_LUNGHEZZA_STRINGA:
				errore = new ErroreDialog(eccezioneSQL, "Salvataggio Fallito",
	...
	private void ricavaInfoDipendente(ControllerGestioneProfilo controller)
			throws SQLException, IllegalFieldValueException {
