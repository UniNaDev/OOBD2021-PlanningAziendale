...
public class MieiProgetti extends JFrame {
	...
	public MieiProgetti(ControllerProgetto controller, Dipendente dipendente) {
				...
				.addGroup(gl_contentPane.createSequentialGroup()
						.addGroup(gl_contentPane
								...
								.addGroup(gl_contentPane.createSequentialGroup().addGap(36)
										.addComponent(mieiProgettiScrollPane, GroupLayout.DEFAULT_SIZE, 619,
												Short.MAX_VALUE)
		...
		gl_infoProgettoPanel.setHorizontalGroup(gl_infoProgettoPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_infoProgettoPanel.createSequentialGroup().addContainerGap().addGroup(gl_infoProgettoPanel
						.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_infoProgettoPanel.createSequentialGroup().addGroup(gl_infoProgettoPanel
								.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_infoProgettoPanel.createSequentialGroup().addGap(4)
										.addGroup(gl_infoProgettoPanel.createParallelGroup(Alignment.TRAILING)
												.addComponent(dataCreazioneLabel, Alignment.LEADING,
														GroupLayout.DEFAULT_SIZE, 594, Short.MAX_VALUE)
												.addComponent(tipologiaLabel, Alignment.LEADING,
														GroupLayout.DEFAULT_SIZE, 594, Short.MAX_VALUE)
												.addComponent(ambitiLabel, GroupLayout.DEFAULT_SIZE, 594,
														Short.MAX_VALUE)
												.addComponent(dataScadenzaLabel, Alignment.LEADING,
														GroupLayout.DEFAULT_SIZE, 594, Short.MAX_VALUE)
												.addComponent(dataTerminazioneLabel, Alignment.LEADING,
														GroupLayout.DEFAULT_SIZE, 594, Short.MAX_VALUE)
												.addComponent(panel, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 93,
														GroupLayout.PREFERRED_SIZE)))
								.addGroup(
										gl_infoProgettoPanel.createSequentialGroup().addGap(10)
												.addComponent(nomeProgettoLabel, GroupLayout.DEFAULT_SIZE, 578,
														Short.MAX_VALUE)
												.addGap(10)))
								.addContainerGap())
						.addGroup(Alignment.TRAILING, gl_infoProgettoPanel.createSequentialGroup().addGap(12)
								.addComponent(descrizioneScrollPane, GroupLayout.DEFAULT_SIZE, 586, Short.MAX_VALUE)
								.addGap(12)))));
		gl_infoProgettoPanel.setVerticalGroup(gl_infoProgettoPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_infoProgettoPanel.createSequentialGroup().addGap(5)
						.addComponent(panel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(nomeProgettoLabel).addGap(78)
						.addComponent(ambitiLabel, GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE).addGap(34)
						...
						.addGap(38).addComponent(descrizioneScrollPane, GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
						.addGap(23)));
