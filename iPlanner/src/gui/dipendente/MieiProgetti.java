							...
							.addGroup(gl_infoProgettoPanel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_infoProgettoPanel.createSequentialGroup()
									...
									.addGroup(gl_infoProgettoPanel.createParallelGroup(Alignment.TRAILING)
										.addComponent(dataCreazioneLabel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 594, Short.MAX_VALUE)
										.addComponent(tipologiaLabel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 594, Short.MAX_VALUE)
										.addComponent(ambitiLabel, GroupLayout.DEFAULT_SIZE, 594, Short.MAX_VALUE)
										.addComponent(dataScadenzaLabel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 594, Short.MAX_VALUE)
										.addComponent(dataTerminazioneLabel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 594, Short.MAX_VALUE)
										.addComponent(panel, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE)))
								.addGroup(gl_infoProgettoPanel.createSequentialGroup()
									.addGap(10)
